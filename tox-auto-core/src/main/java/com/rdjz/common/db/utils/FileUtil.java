...
public class FileUtil {
	...
	public static void writeOnce(String fileName, String content) {
	...
	public static boolean copyFile(File oldFile, String newPath) {
		if (!(oldFile.exists())) {
			throw new RuntimeException("文件不存在：" + oldFile);
		}
		if (!(oldFile.isFile())) {
			throw new RuntimeException(oldFile + "不是文件");
		}
	...
	public static void main(String[] args) {
		System.out.println(getContent("D:/CMS系统.txt", "GBK"));
	}
